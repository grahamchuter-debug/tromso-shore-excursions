...
export const metadata: Metadata = buildPageMetadata({
  ...
  description:
    "Privacy policy for Tromso Shore Excursions: how this independent cruise planning website handles information.",
  path: "/privacy",
});
...
export default function PrivacyPage() {
  return (
    <ContentPage
      title="Privacy Policy"
      lead="This privacy notice describes Tromso Shore Excursions as it operates today: an informational cruise planning site without live booking or payment processing."
    ...
    >
      <section>
        ...
        <p>
          ...
          {siteConfig.url}. It provides independent Tromsø cruise-port planning
          information.
        </p>
      </section>
