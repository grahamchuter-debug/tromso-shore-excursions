...
function compareValues(
  a: TromsoScheduleEntry,
  b: TromsoScheduleEntry,
  key: SortKey,
): number {
    ...
    <div className="space-y-4">
      <label className="block">
        ...
        <input
          ...
          aria-label="Search Tromsø ship schedule"
