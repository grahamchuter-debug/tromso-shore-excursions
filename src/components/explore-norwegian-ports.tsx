...
export const explorePortsFromTromso: ExploreNorwegianPortsConfig = {
  intro: (
    <>
      If your itinerary includes more than one Norwegian port, plan each call
      around your ship&apos;s timetable before you sail. Many Arctic and fjord
      cruises pair Tromsø with{" "}
      <a
      ...
      , and{" "}
      <a
        href="https://skjoldenshoreexcursions.com"
        className="font-medium text-[var(--norway-blue)] underline-offset-2 hover:underline"
      >
  ...
  cards: [
    ...
    {
      title: "Skjolden Shore Excursions",
      titleHref: "https://skjoldenshoreexcursions.com",
      description:
        "Compare Skjolden Sognefjord tours, llama walks, port guides, and cruise planning tools.",
      ctaLabel: "Visit Skjolden Shore Excursions",
      ctaHref: "https://skjoldenshoreexcursions.com",
      image: siteImages.skjoldenPortCard,
      imageAlt: imageAlts.skjoldenPortCard,
    },
  ],
};
