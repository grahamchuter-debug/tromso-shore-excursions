...
import {
  ...
  type getTromsoMonthSummaries,
} from "@/lib/tromso-schedules";

type MonthSummary = ReturnType<typeof getTromsoMonthSummaries>[number];
  ...
  return (
    <div className="space-y-10">
      ...
      <p className="text-sm leading-6 text-slate-500">
        ...
        {tromsoScheduleIntegrity.lastDate
